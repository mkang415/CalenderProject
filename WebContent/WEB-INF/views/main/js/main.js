(function($) {
  ...
  // custom scroll self made
  // function onclick(event) {
  // admin_scrolling('.admin_scroll1')
  // }
  function scrolling(pos) {
    $('html, body').animate({'scrollDown' : '$(pos).offset().top_px'}, "slow");
  }

  $('#event-select event-select-baseball').click(function( e ) {
    e.preventDefault();
